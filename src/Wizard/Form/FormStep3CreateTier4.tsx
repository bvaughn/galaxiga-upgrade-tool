...
import { PendingCreateTier4Item } from "../types";
import styles from "./shared.module.css";

export function FormStep3CreateTier4({
  goToNextStep,
  goToPreviousStep,
  items,
  onDismiss,
  ...
  goToNextStep: (value?: PendingCreateTier4Item) => void;
  goToPreviousStep: () => void;
  items: Item[];
  onDismiss: () => void;
  pendingAction: PendingCreateTier4Item;
}) {
